...
export default function HomePage() {
  ...
  return (
    <div className="relative flex min-h-screen w-screen max-w-[100vw] flex-col overflow-x-hidden bg-background">
      <header
        className="sticky top-0 z-[100] shrink-0 border-b border-white/10 bg-black pointer-events-none"
        style={{ paddingTop: 'env(safe-area-inset-top)' }}
      >
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-2 gap-y-1 px-3 py-1.5 sm:px-4">
          <span className="text-xs font-medium font-space-grotesk text-muted-foreground">
      ...
      <div className="relative flex min-h-0 flex-1 flex-col items-center justify-start pb-[env(safe-area-inset-bottom)]">
        ...
        <div
          className="pointer-events-none absolute inset-0 z-[1] h-[75vh] w-full -translate-y-[100px]"
          style={{
            maskImage:
